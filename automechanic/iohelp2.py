...
def addition_xyz_string_dictionary(rid, idxs, mgeo_dct):
    """
    """
    dxyz_dct = None
...
def abstraction_xyz_string_dictionary(rid, idxs, mgeo_dct):
    """
    """
    dxyz_dct = None
...
if __name__ == '__main__':
    print _sorted_abstraction_candidate('[CH3].O>>[OH].C')
    print _sorted_addition_candidates('[CH2]_m3.C#C_m1>>[CH]C=C_m3')
