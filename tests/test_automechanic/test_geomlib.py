...
def test__find_hydrogen_abstraction():
    ...
    """
    r1_mgeo = (('C', (1.057143885742, -0.0871511930619, -0.04674477657599)),
    ...
    r2_mgeo = (('O', (0.93765321301, -0.0694961347519, 0.0634458694842)),
               ('H', (0.658804017340, 0.569095658158, -0.609907417816)),
               ('H', (1.905540138587, -0.0375451195842, 0.02975561330711)))
    p1_mgeo = (('O', (0.93765321301, -0.0694961347519, 0.0634458694842)),
               ('H', (1.905540138587, -0.0375451195842, 0.02975561330711)))
    p2_mgeo = (('C', (1.059090261904, -0.0718353638623, 0.04370704218484)),
    ...
    forw, back = geomlib.find_hydrogen_abstraction(r_mgeos, p_mgeos)
    _, forw_idxs = zip(*forw)
    _, back_idxs = zip(*back)
    print forw_idxs
    print back_idxs
    assert forw == ((r2_mgeo, 2), (r1_mgeo, 1))
    assert back == ((p2_mgeo, 8), (p1_mgeo, 0))
